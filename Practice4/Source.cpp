...
void reshape(int w, int h)
{
	...
	gluOrtho2D(40, 80, 60, 80);/*визуализируем графику в 2D режиме*/
...
void display() {
	...
	GLdouble plane[4] = { -115, 105, 0, 0 };/*задать массиву координаты*/
	glClipPlane(GL_CLIP_PLANE0, plane); /*Функция отсечение*/
	glEnable(GL_CLIP_PLANE0);/*активация функции*/
	...
	glFlush();
	glDisable(GL_CLIP_PLANE0);/*деактивация*/
}
